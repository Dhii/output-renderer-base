...
use Dhii\Output\Exception\CouldNotRenderException as TestSubject;
 ...
 * @since [*next-version*]
 */
class CouldNotRenderExceptionTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Output\Exception\CouldNotRenderException';
     ...
     */
    public function createInstance($message = null, $code = null, $previous = null, $renderer = null)
    {
