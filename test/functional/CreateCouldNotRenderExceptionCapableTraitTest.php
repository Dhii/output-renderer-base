...
use Dhii\Output\CreateCouldNotRenderExceptionCapableTrait as TestSubject;
 ...
 * @since [*next-version*]
 */
class CreateCouldNotRenderExceptionCapableTraitTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Output\CreateCouldNotRenderExceptionCapableTrait';
    ...
    /**
     * Tests that a Could Not Render exception can be created correctly.
     *
     * @since [*next-version*]
     */
    public function testCreateCouldNotRenderException()
    {
        ...
        $exception = $_subject->_createCouldNotRenderException($message, $code, $previous, $renderer);
